...
<header>
  <nav>
    ...
    %>
          ...
          <li>
            <a href="/epiflex/Profile" class="waves-effect waves-light">
              <i class="material-icons right" data-toggle="modal" data-target="#myModal">face</i><%=username%></a>
          </li>
        <%}else{%>
          <li>
            <a class="waves-effect waves-light modal-trigger" href="#modal-profil">S'authentifier</a>
          </li>
        <%}%>
      </ul>
    </div>
